...
function RWMPower:createChildren()
    ...
    self.toggleOnOffButton = ISButton:new(xoff+UI_BORDER_SPACING, UI_BORDER_SPACING+1, buttonW,BUTTON_HGT,getText("ContextMenu_Turn_On"),self, RWMPower.toggleOnOff);
    ...
    self.itemDropBox = ISItemDropBox:new (xoff+UI_BORDER_SPACING, self.toggleOnOffButton.y, BUTTON_HGT, BUTTON_HGT, false, self, RWMPower.addBattery, RWMPower.removeBattery, RWMPower.verifyItem, nil );
    ...
    self.batteryStatus = ISBatteryStatusDisplay:new ( xoff+UI_BORDER_SPACING, self.toggleOnOffButton.y, self.width-(UI_BORDER_SPACING*2+xoff), BUTTON_HGT, true);
