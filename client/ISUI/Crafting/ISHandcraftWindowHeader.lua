...
function ISHandcraftWindowHeader:initialise()
	ISPanel.initialise(self);
end

function ISHandcraftWindowHeader:createChildren()
    ...
    local titleStr = getText("IGUI_CraftingWindow_Title");
...
function ISHandcraftWindowHeader:calculateLayout(_preferredWidth, _preferredHeight)
...
function ISHandcraftWindowHeader:render()
    ISPanel.render(self);
end

function ISHandcraftWindowHeader:update()
    ISPanel.update(self);
end
