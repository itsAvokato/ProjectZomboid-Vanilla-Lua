...
function WelcomeMessageUI:render()
    ...
    self.rich.text =
    "<CENTRE> <SIZE:small> - The firearms aiming system has been upgraded.  Use the aiming reticule to target specific body parts. <LINE><LINE> - Building and Crafting are now done by pressing the new icons at the top left. <LINE><LINE> - Hold E to pick up and drag bodies, and the same to drop them. <LINE><LINE> - Farm animals need a Livestock Zone, and will never leave it if they feel safe - even if it's unfenced. <LINE><LINE> - Gamepad and Steamdeck functionality has not yet been upgraded.";
    self.rich:paginate()
