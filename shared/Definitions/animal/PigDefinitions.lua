...
AnimalDefinitions.breeds["pig"].breeds["landrace"].rottenTexture = "Pig_Rotting";
...
AnimalDefinitions.breeds["pig"].breeds["landrace"].invIconMaleSkel = "Item_Skeleton_Pig";
AnimalDefinitions.breeds["pig"].breeds["landrace"].invIconFemaleSkel = "Item_Skeleton_Pig";
AnimalDefinitions.breeds["pig"].breeds["landrace"].invIconBabySkel = "Item_Skeleton_Pig_Piglet";
...
AnimalDefinitions.breeds["pig"].breeds["largeblack"].rottenTexture = "PigBoar_Rotting";
...
AnimalDefinitions.breeds["pig"].breeds["largeblack"].invIconMaleSkel = "Item_Skeleton_Pig";
AnimalDefinitions.breeds["pig"].breeds["largeblack"].invIconFemaleSkel = "Item_Skeleton_Pig";
AnimalDefinitions.breeds["pig"].breeds["largeblack"].invIconBabySkel = "Item_Skeleton_Pig_Piglet";
...
AnimalDefinitions.animals["piglet"].textureSkeletonBloody = "PigSkeleton_Butchered";
AnimalDefinitions.animals["piglet"].bodyModelSkelNoHead = "Piglet_Skeleton_NoHead";
...
AnimalDefinitions.animals["sow"].textureSkeletonBloody = "PigSkeleton_Butchered";
AnimalDefinitions.animals["sow"].bodyModelSkelNoHead = "Pig_Skeleton_NoHead";
...
AnimalDefinitions.animals["boar"].textureSkeletonBloody = "PigSkeleton_Butchered";
AnimalDefinitions.animals["boar"].bodyModelSkelNoHead = "Pig_Skeleton_NoHead";
