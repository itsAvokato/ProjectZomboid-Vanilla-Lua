...
AnimalDefinitions.breeds["chicken"].breeds["rhodeisland"].rottenTexture = "ChickenBrown_Rotting";
...
AnimalDefinitions.breeds["chicken"].breeds["leghorn"].rottenTexture = "ChickenWhite_Rotting";
...
AnimalDefinitions.animals["chick"].textureSkeletonBloody = "ChickenSkeleton_Butchered";
AnimalDefinitions.animals["chick"].bodyModelSkelNoHead = "Chicken_Chick_Skeleton_NoHead";
...
AnimalDefinitions.animals["chick"].canBeKilledWithoutWeapon = true;
...
AnimalDefinitions.animals["hen"].textureSkeletonBloody = "ChickenSkeleton_Butchered";
AnimalDefinitions.animals["hen"].bodyModelSkelNoHead = "Chicken_Skeleton_NoHead";
...
AnimalDefinitions.animals["hen"].canBeKilledWithoutWeapon = true;
...
AnimalDefinitions.animals["cockerel"].textureSkeletonBloody = "ChickenSkeleton_Butchered";
AnimalDefinitions.animals["cockerel"].bodyModelSkelNoHead = "Cockerel_Skeleton_NoHead";
...
AnimalDefinitions.animals["cockerel"].canBeKilledWithoutWeapon = true;
