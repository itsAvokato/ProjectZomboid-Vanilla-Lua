...
AnimalDefinitions.breeds["sheep"].breeds["suffolk"].rottenTexture = "Sheep_Rotting";
...
AnimalDefinitions.breeds["sheep"].breeds["suffolk"].invIconMaleSkel = "Item_Skeleton_Sheep";
AnimalDefinitions.breeds["sheep"].breeds["suffolk"].invIconFemaleSkel = "Item_Skeleton_Sheep";
AnimalDefinitions.breeds["sheep"].breeds["suffolk"].invIconBabySkel = "Item_Skeleton_Sheep_Lamb";
...
AnimalDefinitions.breeds["sheep"].breeds["rambouillet"].rottenTexture = "Sheep_Rotting";
...
AnimalDefinitions.breeds["sheep"].breeds["rambouillet"].invIconMaleSkel = "Item_Skeleton_Sheep";
AnimalDefinitions.breeds["sheep"].breeds["rambouillet"].invIconFemaleSkel = "Item_Skeleton_Sheep";
AnimalDefinitions.breeds["sheep"].breeds["rambouillet"].invIconBabySkel = "Item_Skeleton_Sheep_Lamb";
...
AnimalDefinitions.breeds["sheep"].breeds["friesian"].rottenTexture = "Sheep_Rotting";
...
AnimalDefinitions.breeds["sheep"].breeds["friesian"].invIconMaleSkel = "Item_Skeleton_Sheep";
AnimalDefinitions.breeds["sheep"].breeds["friesian"].invIconFemaleSkel = "Item_Skeleton_Sheep";
AnimalDefinitions.breeds["sheep"].breeds["friesian"].invIconBabySkel = "Item_Skeleton_Sheep_Lamb";
...
AnimalDefinitions.animals["lamb"].textureSkeletonBloody = "SheepSkeleton_Butchered";
AnimalDefinitions.animals["lamb"].bodyModelSkelNoHead = "Sheep_LambSkeleton_NoHead";
...
AnimalDefinitions.animals["ewe"].textureSkeletonBloody = "SheepSkeleton_Butchered";
AnimalDefinitions.animals["ewe"].bodyModelFleece = "Sheep_EweFleece";
AnimalDefinitions.animals["ewe"].bodyModelSkelNoHead = "Sheep_EweSkeleton_NoHead";
...
AnimalDefinitions.animals["ram"].textureSkeletonBloody = "SheepSkeleton_Butchered";
AnimalDefinitions.animals["ram"].bodyModelFleece = "Sheep_RamFleece";
AnimalDefinitions.animals["ram"].bodyModelSkelNoHead = "Sheep_RamSkeleton_NoHead";
